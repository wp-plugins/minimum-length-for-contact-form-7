...
function wpcf7_min_text_init()
{
	if(function_exists('wpcf7_add_shortcode'))
	{
		wpcf7_add_shortcode(
			...
			'wpcf7_min_text_shortcode_handler', true
		);
	}

	add_filter( 'wpcf7_validate_text', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_text*', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_email', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_email*', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_url', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_url*', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_tel', 'wpcf7_min_text_validation_filter', 10, 2 );
	add_filter( 'wpcf7_validate_tel*', 'wpcf7_min_text_validation_filter', 10, 2 );
}
...
function wpcf7_min_text_validation_filter( $result, $tag ) {
	...
	if (strlen($value) < $minlength[0] && '' == $value ) {
			$result['valid'] = false;
